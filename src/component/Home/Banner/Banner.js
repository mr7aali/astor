      ...
      >
        <SwiperSlide>
          ...
          <div className='Banner-Blg-container'>
            <h1 className='text-5xl xl:text-6xl text-white font-bold text-center'>Sell your mobile with  <br /> <span className='text-red-700'>Best price</span></h1>
            <p className='text-white m-10 px-10 text-2xl xl:text-3xl text-center '>Fortunately you've come to the right place! SellCell is the best place to sell phones, tablets and other mobile devices. We compare prices from all the leading cell phone buyers in the US to get you the most cash and also save  you time and hassle. <span className='extra'>If you want to sell a phone or tablet then SellCell is the only site you need!</span> </p>

            <div className="h-14 w-1/3 mx-auto mt-[150px]" >
              <Button style={{
        ...
        <SwiperSlide>
          ...
          <div className='Banner-Blg-container'>
            <h1 className=' text-5xl xl:text-6xl text-white font-bold text-center'> You can buy phone in <br /> <span className='text-red-700'>Cheapest Price</span></h1>
            <p className='text-white m-10 px-10 text-2xl xl:text-3xl text-center'>
              ...
              <div className="h-14 w-1/3 mx-auto mt-[130px]" >
              <Button style={{
                border: '1px solid white'
              }} variant="text" fullWidth color="primary" size="large">
                <span className="text-[white] font-bold"> Bye Phone</span>
        ...
        <SwiperSlide>
          ...
          <div className='Banner-Blg-container'>
            <h1 className='text-5xl xl:text-6xl text-white font-bold text-center'> You can easily  <br /> <span className='text-red-700'>Connect With Your Byer </span></h1>
            <p className='text-white m-10 px-10 text-2xl xl:text-3xl text-center'>Generate leads, drive website traffic, and build brand awareness
